    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-primary-25 to-primary-100 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl text-gray-700 font-medium">Create your account</h2>
          <p className="text-gray-500 mt-2">Join thousands of professionals optimizing their resumes</p>
        </div>
